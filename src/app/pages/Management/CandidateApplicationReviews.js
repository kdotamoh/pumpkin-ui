...
const mapDispatchToProps = (dispatch) => ({
    ...
    getCandidateApplicationReviews: (reviewerCode, seoDecision, currentPage) =>
        dispatch(getCandidateApplicationReviews(reviewerCode, seoDecision, currentPage - 1)),
