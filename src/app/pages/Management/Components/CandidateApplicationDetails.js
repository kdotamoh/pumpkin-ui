...
const CandidateApplicationDetails = ({candidateApplicationSummary}) => (
    <>
            ...
            <div>
                <div className="data-row">
                    ...
                    <div className="flex-1">Current Stage
                        - {candidateApplicationSummary.applicationStage}</div>
                </div>
                <div className="data-row">
                ...
                <div className="data-row">
                    <div className="flex-1">Applied Using This Link
                        - {candidateApplicationSummary.applicationFormat || "N/A"}</div>
                </div>
            </div>
        </div>
