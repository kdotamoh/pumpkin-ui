...
const CandidateApplicationReviews = ({candidateApplicationSummary}) => (
    <>
                            ...
                            <Panel header={<div>
                                ...
                                <div>
                                    <div className="sub-content">
                                        <div className="sub-content-header">SEO'S Review</div>
                                        <div className="flex-1">Decision
                                            - <span
                                                style={seoDecisionStyle}>{reviewsPerStage.seoDecision}</span>
                                        </div>
                                        <div>
